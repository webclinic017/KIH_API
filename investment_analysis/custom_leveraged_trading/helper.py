...
if typing.TYPE_CHECKING:
    from investment_analysis.custom_leveraged_trading.models import HistoricalData, HistoricalReturn
...
class InvestmentAnalysisHelper:
    ...
    def get_leveraged_historical_data_list(starting_balance: Decimal, leverage: Decimal, historical_data_list: List["HistoricalData"]) -> List["HistoricalReturn"]:
        from investment_analysis.custom_leveraged_trading.models import HistoricalReturn
