...
def send_email(to_address_list: List[str], email_subject: str, email_content: str) -> None:
    ...
    logger.debug(constants.execution_type__Email_Server + "|" + "Connection Establishment" + "|" + "" + "|" + str(time.time() - start_time))
    ...
    logger.debug(constants.execution_type__Email_Server + "|" + "Authentication" + "|" + "" + "|" + str(time.time() - start_time))
    ...
    logger.debug(constants.execution_type__Email_Server + "|" + "Sending Email" + "|" + str(email) + "|" + str(time.time() - start_time))
