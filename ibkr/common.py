    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> None:
            if not is_run_only_when_market_is_open or (is_run_only_when_market_is_open and IBKR.is_market_open(symbol_to_check_market_open)):
                ...
                communication.telegram.send_message(communication.telegram.constants.telegram_channel_development_username, f"Market is not open; job skipped: <i>{job_name}</i>", True)
